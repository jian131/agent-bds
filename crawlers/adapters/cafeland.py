"""
Cafeland.vn Platform Adapter

Real estate news and listings platform.
"""
...
class CafelandAdapter(BasePlatformAdapter):
    """Adapter for cafeland.vn"""

    platform_id = "cafeland"
    platform_name = "Cafeland.vn"
    base_url = "https://cafeland.vn"
    ...
    def build_search_url(
        ...
        **kwargs
        ...
        if city:
            ...
            city_code = self.CITY_CODES.get(city_lower)
            if city_code:
                params.append(f"tinh={city_code}")
    ...
    def parse_search_results(self, html: str) -> list[UnifiedListing]:
        ...
        cards = soup.select(".realestate-item, .item-list, article")
...
PlatformRegistry.register(CafelandAdapter)
